...
```{r htmlwidgets_3, echo = FALSE, message = FALSE, results = 'asis', comment = NA, cache = TRUE}
# library(networkD3)
# # Load data
# data(MisLinks)
# data(MisNodes)
...
## Interactive graphics and presentations  
#### Interesting: graph analysis
```{r htmlwidgets_4, echo = FALSE, message = FALSE, results = 'asis', comment = NA, cache = TRUE}
# URL <- paste0(

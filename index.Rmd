...
```{r rcharts_3, echo = FALSE, message = FALSE, results = 'asis', comment = NA, cache = FALSE}
# library(leaflet)
# library(rgdal)
# countries <- readOGR("files/countries.geojson", "OGRGeoJSON", verbose = FALSE)
...
## Interactive graphics and presentations  
#### Maps 2
```{r rcharts_4, echo = FALSE, message = FALSE, results = 'asis', comment = NA, cache = FALSE}
# library(highcharter)
# library(viridisLite)
# library(htmlwidgets)
# 

...
*Комбинация мощных и стабильных библиотек R и Python для отдельных задач исследования*:
- **_Python_** - язык общего назначения:  
       - Web scraping и crawling (beautifulsoup, Scrapy, и т.д.) 
       - Работа с базами данных и различными приложениями (sqlachemy, и т.д.) 
       - Реализация классических алгоритмов машинного обучения (scikit-learn, pandas, numpy, scipy, и т.д.)  
- **_R_** - обширная коллекция библиотек:  
   - Продвинутый статистический анализ. В особенности, для ряда специфических областей науки и практики (анализ временных рядов: trading, эконометрика, и т.д. и т.п.) 

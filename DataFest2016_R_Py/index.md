...
-----------|------------
[*rPython*](https://rpython.readthedocs.io/en/latest/)    | - Java code<br>- передача данных через json<br>- непрямая передача таблиц<br>- [хорошая документация](https://cran.r-project.org/web/packages/rPython/rPython.pdf)<br>- [слабая поддержка Windows](https://github.com/cjgb/rPython-win)<br>- часто падает с Anaconda
